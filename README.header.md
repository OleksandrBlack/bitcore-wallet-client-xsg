...
The *official* client library for [bitcore-wallet-service-safe] (https://github.com/OleksandrBlack/bitcore-wallet-service-safe).

## Description

This package communicates with BWS [Bitcore wallet service SAFE](https://github.com/OleksandrBlack/bitcore-wallet-service-safe) using the REST API. All REST endpoints are wrapped as simple async methods. All relevant responses from BWS are checked independently by the peers, thus the importance of using this library when talking to a third party BWS instance.
...
* via [NPM]: by running `npm install https://github.com/OleksandrBlack/bitcore-wallet-service-safe.git`
from your console.

## Example

Start your own local [Bitcore wallet service SAFE](https://github.com/OleksandrBlack/bitcore-wallet-service-safe) instance. In this example we assume you have `bitcore-wallet-service-safe` running on your `localhost:3232`.
...
``` javascript
var Client = require('bitcore-wallet-client-safe');
...
Install `bitcore-wallet-client-safe` before start:

```
npm install https://github.com/OleksandrBlack/bitcore-wallet-service-safe.git
```
